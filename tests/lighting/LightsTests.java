...
public class LightsTests {
    ...
    public void trianglesPoint() {
        ...
        scene2.lights.add(new PointLight(trCL, trPL).setKl(0.00001).setKq(0.000002));
        scene2.lights.add(new SpotLight(new Color(230,40,50),trPL, new Vector(1,3,5)).setKl(0.00001).setKq(0.0003));
        scene2.lights.add(new SpotLight(new Color(23,10,0),trPL, new Vector(1,4,5)).setKl(0.01).setKq(0.000003));
        scene2.lights.add(new SpotLight(new Color(10,250,10),trPL, new Vector(0,8,9)).setKl(0.000001).setKq(0.003));
